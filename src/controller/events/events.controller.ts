...
export class EventsController {
	...
	static getByIdHandler = (req: Request<ReadEventInput['params']>, res: Response) =>
		getById(req, res);

	/** Sync events from CSV to AWS. */
	static syncToDynamoHandler = (req: Request, res: Response) => syncEventsDynamo(req, res);

	/** @deprecated
	 * Directus events list */
	static getListHeadlessHandler = (req: Request, res: Response) => getListHeadless(req, res);

	static getByIdHeadlessHandler = (req: Request<ReadCalendarEventInput['params']>, res: Response) =>
		getByIdHeadless(req, res);

	/** Sync events from Directus to Google Calendar. @todo - skip Directus in favour of CSV. */
	static syncToGoogleCalendarHandler = (req: Request, res: Response) => syncEventsGoogle(req, res);
