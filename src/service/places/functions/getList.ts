...
import { TimeOfDayBits } from '../../../models/enums/tod.enum.js';
...
import { getBitwiseValue, PLACE_FILTER_FIELDS } from '../utils.js';
...
export default async function (
	...
	try {
		...
		documents = PlaceModel.scan().where(PLACE_FILTER_FIELDS.active).eq(true);
