...
class DirectusService {
  public async getItems<T extends keyof HeadlessSchema>(
    schema: T,
    page: number,
    limit: number
  ) {
  ...
  public async getTotalItemCount<T extends keyof HeadlessSchema>(
    schema: T
  ): Promise<number> {
  ...
  public async getAllDirectusItems<
    T extends keyof HeadlessSchema,
    TDirectusItemSchema
  >(schema: T): Promise<TDirectusItemSchema[]> {
