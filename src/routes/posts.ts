...
/** Create new post */
router.post("/create", [requireUser, validateResource(createPostSchema)], PostsController.createPostHandler);

/** Update post by ID */
router.patch("/:postId", [requireUser, validateResource(updatePostSchema)], PostsController.updatePostHandler);
